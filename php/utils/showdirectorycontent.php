...
echo "<td><button class=\"btn\" type=\"button\" onclick=\"deletedirectory('$vollerpfad');\">Löschen</button></td>";
echo "<td><button class=\"btn\" type=\"button\" onclick=\"renamefile('$ordner[name]');\">Umbenennen</button></td>";
echo "</tr>";
}
